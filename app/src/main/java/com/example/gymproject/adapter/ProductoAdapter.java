...
public class ProductoAdapter extends RecyclerView.Adapter<ProductoAdapter.MyViewHolder> implements Filterable {
    ...
    public ProductoAdapter (Context context,List<ProductoModelo> products){
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_productos,parent,false);
